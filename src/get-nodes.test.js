...
const { X_VALUES, Y_VALUES, n, INTERPOLATION_X, getNodesResult } = require('./test-data')
...
const testCases = [
  ...
  {
    description: 'Return null if some of the arrays elements has incorrect type',
    expected: null,
    actual: getNodes(X_VALUES, [1, 2, 3, 'i am a string', 4], n, INTERPOLATION_X)
  },
  {
